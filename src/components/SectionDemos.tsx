...
export const SectionDemos = () => {
    ...
    return (
      ...
      >
        <div className="relative">
          ...
          />
          <div className="group bg-opacity-0 hover:bg-opacity-40 absolute inset-0 z-10 flex items-center justify-center rounded-lg bg-slate-900 text-slate-100 transition-all duration-200">
        ...
        <div className="p-3">
          <span className="flex items-center text-base font-medium text-slate-100 capitalize">
            {item.text}
  ...
  return (
    <div className="dark container text-slate-100">
      <p className="text-4xl font-semibold tracking-tight text-pretty sm:text-5xl">
