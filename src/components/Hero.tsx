...
export function Hero() {
  return (
    <Container className="overflow-hidden pt-8 pb-16 text-center sm:pt-12 2xl:pt-24">
      <div className="inline-flex items-center justify-center gap-2 rounded-full bg-slate-50 px-5 py-1.5 text-sm font-medium ring-1 ring-gray-500/10 ring-inset">
        <HomeModernIcon className="-ml-1.5 size-5" />
        <span className="text-gray-700">
          Stays, experiences, cars & flights
        </span>
      </div>
      <h1 className="mx-auto mt-2 max-w-4xl font-display text-4xl/[1.2] font-medium tracking-tight text-slate-900 sm:text-5xl md:text-6xl lg:text-7xl">
        Premium{' '}
        <span className="relative whitespace-nowrap text-fuchsia-600">
          ...
          <span className="relative">travel booking</span>
        </span>{' '}
        Next.js template
      </h1>
      <p className="mx-auto mt-7 max-w-[49rem] text-xl tracking-tight text-slate-700">
        Ceepii is a premium Next.js template for building modern booking
        platforms like Airbnb & Booking.com, combining high-end UI with a
        scalable frontend to help you launch faster.
      </p>
